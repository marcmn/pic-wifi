...
void Initialize_ESP8266(void)
{
    ...
    //SPBRG = 3; // 57600 baudrate
    //SPBRG = 1; // 115200 baudrate
    //SPBRG = 103; // 2400 baudrate
...
void esp8266_server(unsigned char mode, unsigned char* port) {
...
void esp8266_mux(unsigned char mux) {
    _esp8266_print("AT+CIPMUX=");
    _esp8266_putch(mux + '0');
    _esp8266_print("\r\n");
    _esp8266_waitFor("OK");
}
 ...
 */
uint16_t esp8266_receive(unsigned char* store_in, uint16_t max_length, bool discard_headers) {
